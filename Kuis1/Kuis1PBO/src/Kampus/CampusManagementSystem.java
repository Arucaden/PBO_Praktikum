...
public class CampusManagementSystem {
    ...
    static void addDosen(List<Faculty> faculties) {
    ...
    static void addFacultyAssignment(List<Faculty> faculties, List<Course> courses, List<FacultyAssignment> facultyAssignments) {
        ...
        if (selectedFacultyForAssignment != null && selectedCourseForAssignment != null) {
            FacultyAssignment facultyAssignment = new FacultyAssignment(selectedFacultyForAssignment,
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 6:
                    addFacultyAssignment(faculties, courses, facultyAssignments);
                    break;
